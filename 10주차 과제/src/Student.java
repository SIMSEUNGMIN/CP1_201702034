...
public class Student {
	...
	public double pointEnglish() {
		return this.grade2Point(gradeEnglish());
	}
	...
	public double pointComputer() {
		return this.grade2Point(gradeComputer());
	}
	
	public double gpa() {
		double gradePointKorean, gradePointEnglish, gradePointComputer;
		
		gradePointKorean = this.grade2Point(gradeKorean());
		gradePointEnglish = this.grade2Point(gradeEnglish());
		gradePointComputer = this.grade2Point(gradeComputer());
